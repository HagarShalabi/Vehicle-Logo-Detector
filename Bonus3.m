...
%% 
%1) Read Training Set
A=imread("BonusTrainingSet\BMW.png");
...
G=imread("BonusTrainingSet\ChevTest.jpg");
H=imread("BonusTrainingSet\Olicit3.jpg");
...
Extracted=imcomplement(Extracted);
...
text(50,30,strcat('\color{cyan} Brand: ', result))