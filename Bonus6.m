I=imread("BonusTestCases\Case 3-1.jpg");
...
Cropped = imcrop(I,[720 350 720 390]);
...
B=imread("BonusTrainingSet\BMW3.jpg");
C=imread("BonusTrainingSet\BMW4.jpg");
D=imread("BonusTrainingSet\ChevLogo.png");
E= imread("BonusTrainingSet\BMW.png");
F=imread("BonusTrainingSet\BMWtest.png");
G=imread("BonusTrainingSet\KiaTest.jpeg");
H=imread("BonusTrainingSet\ChevTest.jpg");
...
switch Index
    ...
    case 3
     ...
     case 4
        result='Chevrelot'; OUTPUTIMG=D; 
     case 5
        result='BMW'; OUTPUTIMG=E;
     case 6
