I=imread("BonusTestCases\Case 3-2.jpg");
...
Cropped = imcrop(I,[185 140 80 135]);
nexttile; imshow(Cropped)
title('Cropped');
%%Cropped=imgaussfilt(Cropped, 5);
%%
...
%%Training for logo 
%1) Read Training Set
A=imread("BonusTrainingSet\ChevLogo.png");
B=imread("TrainingSet\KiaTrainingSet\KIA.jpg");
C=imread("BonusTrainingSet\HyundaiTest4.jpg");
D=imread("BonusTrainingSet\HyundaiTest3.jpg");
E= imread("TrainingSet\KiaTrainingSet\Kia1.jpg");
F=imread("TrainingSet\KiaTrainingSet\Kia2.jpg");
G=imread("BonusTrainingSet\HyundaiTest1.jpg");
H=imread("BonusTrainingSet\KiaTest2.jpg");
I=imread("BonusTrainingSet\Olicit2.jpg");
J=imread("BonusTrainingSet\Olicit3.jpg");
K=imread("TrainingSet\KiaTrainingSet\KiaTest3.jpg");
L=imread("BonusTrainingSet\Kia.jpg");
...
switch Index
    case 1
        result='Chevrelot'; OUTPUTIMG=A;
    case 2
        result='Kia'; OUTPUTIMG=B;
    case 3
