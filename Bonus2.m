...
Cropped = imcrop(I,[400 400 400 570]);
%Smoothing salt noise
...
C=imread("BonusTrainingSet\ChevTest.jpg");
...
I=imread("BonusTrainingSet\BMW4.jpg");
J=imread("BonusTrainingSet\BMW3.jpg");
