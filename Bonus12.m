I=imread("BonusTestCases\Case 4-3.jpg");
...
Cropped = imcrop(I,[1600 968 1600 973]);
...
B=imread("BonusTrainingSet\ChevTest.jpg");
C=imread("BonusTrainingSet\Olicit2.jpg");
D=imread("BonusTrainingSet\Olicit3.jpg");
E= imread("BonusTrainingSet\Olicit.jpg");
...
switch Index
    ...
    case 2
        result='Chevrolet'; OUTPUTIMG=B;
    case 3
        result='Olicit'; OUTPUTIMG=C;
     case 4
        result='Olicit'; OUTPUTIMG=D; 
     case 5
        result='Olicit'; OUTPUTIMG=E;
     case 6
