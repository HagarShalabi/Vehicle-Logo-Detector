I=imread("TestCases\Case2-Rear2.jpg");
...
Cropped=imcrop(I, [300 300 300 300]); 
...
Extracted=Cropped.* uint8(Filled);
...
[r, c]=size(Cropped);
LogoImage = imresize(LogoImage,[r c]) ;
...
figure;
showMatchedFeatures(LogoImage, Cropped, matchedLogoPoints, ...
...
text(150,30,strcat('\color{cyan} Brand: ', result))